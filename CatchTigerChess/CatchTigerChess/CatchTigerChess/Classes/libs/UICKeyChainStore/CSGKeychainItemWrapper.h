...
@interface CSGKeychainItemWrapper : NSObject
...
+ (CSGKeychainItemWrapper *)keyChainStoreWithService:(nullable NSString *)service;
+ (CSGKeychainItemWrapper *)keyChainStoreWithService:(nullable NSString *)service accessGroup:(nullable NSString *)accessGroup;
...
@interface CSGKeychainItemWrapper (ErrorHandling)
...
@interface CSGKeychainItemWrapper (ForwardCompatibility)
...
@interface CSGKeychainItemWrapper (Deprecation)
