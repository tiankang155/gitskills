//
//  CSGKeychainItemWrapper.m
//  CSGKeychainItemWrapper
//
...
NSString * const UICKeyChainStoreErrorDomain = @"com.kishikawakatsumi.CSGKeychainItemWrapper";
static NSString *_defaultService;

@interface CSGKeychainItemWrapper ()

@end

@implementation CSGKeychainItemWrapper
...
+ (CSGKeychainItemWrapper *)keyChainStore
{
    return [[self alloc] initWithService:nil accessGroup:nil];
}

+ (CSGKeychainItemWrapper *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (CSGKeychainItemWrapper *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
+ (CSGKeychainItemWrapper *)keyChainStoreWithServer:(NSURL *)server protocolType:(UICKeyChainStoreProtocolType)protocolType
{
...
+ (CSGKeychainItemWrapper *)keyChainStoreWithServer:(NSURL *)server protocolType:(UICKeyChainStoreProtocolType)protocolType authenticationType:(UICKeyChainStoreAuthenticationType)authenticationType
{
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    CSGKeychainItemWrapper *keychain = [CSGKeychainItemWrapper keyChainStoreWithService:service accessGroup:accessGroup];
...
@implementation CSGKeychainItemWrapper (Deprecation)
